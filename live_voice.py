...
def mentions_teacher(text):
    ...
    return (
        ...
        "lão sư" in normalized

        or "lao su" in remove_accents(text)
...
async def process_user_text(
    ...
    # ========================================================
    # IGNORE TIỂU VŨ OUTPUT TRANSCRIPTION
    # ========================================================
    ...
    if intent == "start_lesson":
        ...
        if (
            ...
            print(
                ...
                "ℹ️ Đã đang học với học sinh này.",
